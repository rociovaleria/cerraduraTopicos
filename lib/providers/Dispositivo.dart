...
//comienza a buscar los dispositivos y loas añade a result
...
class BluetoothDeviceListEntry extends ListTile {
  BluetoothDeviceListEntry({
    ...
    enabled: enabled,
    leading: Icon(Icons.devices,color: Color.fromRGBO(201, 156, 239, 100),), // @TODO . !BluetoothClass! class aware icon
    title: Text(device.name ?? "Unknown device",style:TextStyle(color: Color.fromRGBO(201, 156, 239, 100)),),
    subtitle: Text(device.address.toString(),style:TextStyle(color: Color.fromRGBO(201, 156, 239, 100))),
    trailing: Row(
      ...
      children: <Widget>[
        ...
        device.isBonded ? Icon(Icons.link,color: Color.fromRGBO(201, 156, 239, 100),) : Container(width: 0, height: 0),
      ]
    ),
  );
}
